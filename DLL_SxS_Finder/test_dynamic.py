...
def write_excel(path_to_pe, list_dll, number):
    try:
        wb = load_workbook("..\report\SxS_Sideloading_dynamic.xlsx")
    except:
        wb = Workbook()
        wb.save("..\report\SxS_Sideloading_dynamic.xlsx")
...
count = 0
#check_dynamic("c:\\windows\\system32\\sysprep.exe")
check_dir("C:\\windows\\system32")
